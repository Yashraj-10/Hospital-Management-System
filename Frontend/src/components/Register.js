...
const Register = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('/add_patient', { patient_name: patientName, dob: dateOfBirth, ph_number: phoneNumber.slice(1, 13), address: address1, email: emailId, conditions: conditions, gender: sex, access_token: localStorage.getItem('access_token') })
            .then((response) => {
