...
const AdminAddUser = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (Type === "doc") {
            axios.post('/users/add', { name: firstName, type: Type, email: email, docType: doctype, ph_number: phoneNumber.slice(1, 13), address: address1, password: password, access_token: localStorage.getItem("access_token") })
                .then((response) => {
            ...
            axios.post('/users/add', { name: firstName, type: Type, email: email, ph_number: phoneNumber.slice(1, 13), address: address1, password: password, access_token: localStorage.getItem('access_token') })
                .then((response) => {
